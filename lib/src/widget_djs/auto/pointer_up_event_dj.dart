...
part 'pointer_up_event_dj.g.dart';

@JsonSerializable()
class PointerUpEventDj extends BaseWidgetDj {
...
this.pressure, // ignoring defaultValue 0.0
...
baseWidgetDjType = 'PointerUpEvent',
}) : super(
