...
part 'pointer_enter_event_dj.g.dart';

@JsonSerializable()
class PointerEnterEventDj extends BaseWidgetDj {
...
baseWidgetDjType = 'PointerEnterEvent',
}) : super(
