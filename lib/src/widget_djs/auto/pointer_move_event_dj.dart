...
part 'pointer_move_event_dj.g.dart';

@JsonSerializable()
class PointerMoveEventDj extends BaseWidgetDj {
...
this.buttons, // ignoring defaultValue kPrimaryButton
...
baseWidgetDjType = 'PointerMoveEvent',
}) : super(
