...
part 'grid_view_dj.g.dart';

@JsonSerializable()
class GridViewDj extends BaseWidgetDj {
@JsonKey(name: 'key')
...
@override
List<String> toCode() { var codeLines  = <String>[];codeLines.add('GridView(');if(key!=null) {codeLines.add('key:${dynamicParameterParser(key)},');}if(scrollDirection!=null) {codeLines.add('scrollDirection:${dynamicParameterParser(scrollDirection)},');}if(reverse!=null) {codeLines.add('reverse:${dynamicParameterParser(reverse)},');}if(controller!=null) {codeLines.add('controller:${dynamicParameterParser(controller)},');}if(primary!=null) {codeLines.add('primary:${dynamicParameterParser(primary)},');}if(physics!=null) {codeLines.add('physics:${dynamicParameterParser(physics)},');}if(shrinkWrap!=null) {codeLines.add('shrinkWrap:${dynamicParameterParser(shrinkWrap)},');}if(padding!=null) {codeLines.add('padding:${dynamicParameterParser(padding)},');}if(gridDelegate!=null) {codeLines.add('gridDelegate:${dynamicParameterParser(gridDelegate)},');}if(addAutomaticKeepAlives!=null) {codeLines.add('addAutomaticKeepAlives:${dynamicParameterParser(addAutomaticKeepAlives)},');}if(addRepaintBoundaries!=null) {codeLines.add('addRepaintBoundaries:${dynamicParameterParser(addRepaintBoundaries)},');}if(addSemanticIndexes!=null) {codeLines.add('addSemanticIndexes:${dynamicParameterParser(addSemanticIndexes)},');}if(cacheExtent!=null) {codeLines.add('cacheExtent:${dynamicParameterParser(cacheExtent)},');}if(children!=null) {codeLines.add('children:${dynamicParameterParser(children)},');}if(semanticChildCount!=null) {codeLines.add('semanticChildCount:${dynamicParameterParser(semanticChildCount)},');}if(dragStartBehavior!=null) {codeLines.add('dragStartBehavior:${dynamicParameterParser(dragStartBehavior)},');}if(clipBehavior!=null) {codeLines.add('clipBehavior:${dynamicParameterParser(clipBehavior)},');}if(keyboardDismissBehavior!=null) {codeLines.add('keyboardDismissBehavior:${dynamicParameterParser(keyboardDismissBehavior)},');}if(restorationId!=null) {codeLines.add('restorationId:${dynamicParameterParser(restorationId)},');}codeLines.add(')');return codeLines; }
@override
String toString() { return toCode().join(''); }

factory GridViewDj.fromJson(Map<String, dynamic> json) => _$GridViewDjFromJson(json);

@override
Map<String, dynamic> toJson() => _$GridViewDjToJson(this);
}
