...
part 'pointer_hover_event_dj.g.dart';

@JsonSerializable()
class PointerHoverEventDj extends BaseWidgetDj {
...
baseWidgetDjType = 'PointerHoverEvent',
}) : super(
