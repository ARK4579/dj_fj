...
part 'elevated_button_dj.g.dart';

@JsonSerializable()
class ElevatedButtonDj extends BaseWidgetDj {
@JsonKey(name: 'key')
...
this.child,
baseWidgetDjType = 'ElevatedButton',
}) : super(
