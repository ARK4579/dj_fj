...
part 'pointer_down_event_dj.g.dart';

@JsonSerializable()
class PointerDownEventDj extends BaseWidgetDj {
...
baseWidgetDjType = 'PointerDownEvent',
}) : super(
